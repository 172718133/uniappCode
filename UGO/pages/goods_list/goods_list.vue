<template>
	<view class="goods_list">
		...
		<NavBar class="navbar" :navList="['综合', '销量', '价格']"></NavBar>
		<view class="list">
			<navigator :url="'../goods_detail/main?goods_id=' + item.goods_id" class="list_item" v-for="item in goodsList" :key="item.goods_id">
				<view class="image">
